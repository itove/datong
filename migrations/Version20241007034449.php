 ...
 */
final class Version20241007034449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id INT NOT NULL, node_id INT DEFAULT NULL, firstname VARCHAR(15) DEFAULT NULL, lastname VARCHAR(15) DEFAULT NULL, email VARCHAR(35) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, body TEXT NOT NULL, country VARCHAR(30) DEFAULT NULL, sex SMALLINT DEFAULT NULL, province VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, type SMALLINT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D2294458460D9FD7 ON feedback (node_id)');
        $this->addSql('CREATE TABLE image (id INT NOT NULL, node_id INT NOT NULL, image VARCHAR(255) NOT NULL, title VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE node (id INT NOT NULL, language_id INT DEFAULT NULL, category_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, body TEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, summary TEXT DEFAULT NULL, video VARCHAR(255) DEFAULT NULL, audio VARCHAR(255) DEFAULT NULL, qr VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, price INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE spec (id INT NOT NULL, node_id INT NOT NULL, name VARCHAR(25) NOT NULL, value VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
