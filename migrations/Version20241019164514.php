 ...
 */
final class Version20241019164514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE node ADD up INT DEFAULT NULL');
        $this->addSql('ALTER TABLE node ADD down INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE node DROP up');
        $this->addSql('ALTER TABLE node DROP down');
    }
}
